...
font = pygame.font.Font('C:/CP/assets/font/myFont.ttf', 32)
big_font = pygame.font.Font('C:/CP/assets/font/myFont.ttf', 60)
...
for i in range(1, 4):
    ...
    if i < 3:
        ...
        for j in range(1, 5):
            target_images[i - 1].append(pygame.transform.scale(
                pygame.image.load(f'assets/targets/{i}/{j}.png'), (120 - (j * 18), 80 - (j * 12))))
menu_img = pygame.image.load(f'assets/menus/main.png')
